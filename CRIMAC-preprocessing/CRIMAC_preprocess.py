...
def prepare_resume(target_type, target_file, filename_list):
    ...
    last_timestamp = None
    if target_type == "zarr":
        with xr.open_zarr(target_file,consolidated=False) as tmp_src:
...
def rechunk_output(output, output_dir):
    ...
    # Open the files
    alldata = [xr.open_zarr(x,consolidated=False) for x in outputs]
...
if __name__ == '__main__':
    ...
    print("This is the frequency: " + str(main_freq))
    try:
